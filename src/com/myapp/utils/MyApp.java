...
public class MyApp {
	...
	private static  String CLIENTSECRETS_LOCATION = null;

	private static final String REDIRECT_URI = "https://zapdemotest.appspot.com/signIn";
	...
	public static void SetJsonPath(String jsonPath){
		CLIENTSECRETS_LOCATION=jsonPath;
		...
		if (flow == null) {
			...
			GoogleClientSecrets clientSecrets =
					GoogleClientSecrets.load(jsonFactory,
							new FileReader(CLIENTSECRETS_LOCATION));
			flow =
	 ...
	 * @throws IOException Unable to load client_secrets.json.
	 */
	public static Credential getCredentials(String authorizationCode, String state) throws IOException, NoRefreshTokenException  {
		String emailAddress = "";
		try {
